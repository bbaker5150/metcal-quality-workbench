...
const procedures = [
  { Id: 1, Title: 'PT Program Process Manual', Category: 'PT Manual', DocNumber: 'METCAL-PT-001', Discipline: 'All', Url: '', Summary: 'The quality manual governing the round-robin program end to end: artifact selection, reference measurements, participant protocol, evaluation, and corrective action.', UpdatedOn: '2026-02-11' },
  { Id: 2, Title: 'ISO/IEC 17043 — Conformity assessment: requirements for proficiency testing', Category: 'PT Manual', DocNumber: 'ISO/IEC 17043:2023', Discipline: 'All', Url: 'https://www.iso.org/standard/80864.html', Summary: 'The international standard the program is written against. Referenced, not reproduced.', UpdatedOn: '2023-05-01' },
