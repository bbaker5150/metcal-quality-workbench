...
export const CONTAINERS = [
  ...
  },
  {
    ...
    module: 'annual-ltr',
    template: LIST_TEMPLATE.GENERIC,
    description: 'The annual scheduling letter by fiscal year, published to be read rather than routed.',
    fields: [
      ...
      { name: 'FileName', title: 'File', type: FIELD.TEXT, inView: true },
      { name: 'FileSize', title: 'Size', type: FIELD.TEXT },
      { name: 'Url', title: 'Link', type: FIELD.TEXT },
      { name: 'Summary', title: 'Summary', type: FIELD.NOTE, lines: 3 },
    ],
  },
